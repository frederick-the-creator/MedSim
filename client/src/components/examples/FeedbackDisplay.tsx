...
const mockFeedback: ConversationFeedback = {
  overall: "Good consultation overall. You demonstrated strong communication skills and showed empathy. However, there's room for improvement in systematically exploring the patient's ideas, concerns, and expectations.",
  sections: [
    {
