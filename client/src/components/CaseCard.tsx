  ...
  return (
    ...
    >
      <CardHeader className="space-y-3">
        <div>
          <h3 className="text-xl font-semibold mb-1" data-testid={`text-patient-name-${medicalCase.id}`}>
            {medicalCase.patientName}, {medicalCase.age} year old {medicalCase.gender}
          </h3>
        </div>
        <Badge 
          variant="secondary" 
      ...
      <CardContent className="flex-1">
        <p className="text-sm leading-relaxed text-muted-foreground" data-testid={`text-scenario-${medicalCase.id}`}>
